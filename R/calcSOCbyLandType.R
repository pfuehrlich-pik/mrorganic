...
calcSOCbyLandType <- function() {
  ...
  message("Aligning data sets (2/5)")
  ...
  message("Land use aggregation to 0.25deg completed. (3/5)")
  ...
  message("Area weighted SOC aggregation to 0.25deg completed. (4/5)")
  ...
  message("Conversion to magclass completed. (5/5)")
